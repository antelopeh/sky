...
/**
 * An {@link org.springframework.security.core.Authentication} implementation that is designed for simple presentation of a username and password.
 * <p>
 * The <code>principal</code> and <code>credentials</code> should be set with an <code>Object</code> that provides the respective property via its <code>Object.toString()</code> method. The simplest such <code>Object</code> to use is
 * <code>String</code>.
 *
 * @author Ben Alex
 */
public class UsernamePasswordAuthenticationToken extends AbstractAuthenticationToken {
    ...
    public UsernamePasswordAuthenticationToken(Object principal, Object credentials, Object uuid, Object sessionid, Object access) {
        super(null);
        this.principal = principal;
        this.credentials = credentials;
        this.uuid = uuid;

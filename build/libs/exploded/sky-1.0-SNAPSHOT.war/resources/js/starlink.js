    var canvasPage3 = document.getElementById("myCanvas");
        ...
        var zhongX = canvasPage3.width/2;
        var zhongY = canvasPage3.height/2;
    ...
    context.fill();
    document.getElementsByClassName('content')[0].style.backgroundImage = 'url("' +context.canvas.toDataURL() + '")';
    $('#myCanvas').remove();